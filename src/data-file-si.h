...
int init_data_file_si(struct data_file_si* df,
                      const char *file_name,
                      int num_channels);
int clean_data_file_si(struct data_file_si* df);
int data_file_si_load_block(struct data_file_si* df,
                            long int start_index,
                            long int size);
int data_file_si_get_data_one_channel(struct data_file_si* df,
                                      int channel_no,
                                      short int* one_channel,
                                      long int start_index,
                                      long int end_index);
int data_file_si_get_data_all_channels(struct data_file_si* df,
                                       short int* data,
                                       long int start_index,
                                       long int end_index);
int data_file_si_cut_data_file(struct data_file_si* df,
                               char* new_name,
                               long int start_index,
                               long int end_index);
