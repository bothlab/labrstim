...
volatile uint32_t *bcm2835_spi2         = (uint32_t *)MAP_FAILED;
volatile uint32_t *bcm2835_uart1        = (uint32_t *)MAP_FAILED;
...
uint32_t* bcm2835_regbase(uint8_t regbase)
{
    ...
    case BCM2835_REGBASE_SPI2:
        return (uint32_t *)bcm2835_spi2;
    case BCM2835_REGBASE_UART1:
        return (uint32_t *)bcm2835_uart1;
    }
...
int bcm2835_init(void)
{
    ...
    bcm2835_spi2    = bcm2835_peripherals + BCM2835_SPI2_BASE/4;
    bcm2835_uart1   = bcm2835_peripherals + BCM2835_UART1_BASE/4;
...
int bcm2835_close(void)
{
    ...
    bcm2835_spi2  = MAP_FAILED;
    bcm2835_uart1 = MAP_FAILED;
    return 1; /* Success */
}
...
void bcm2835_aux_spi_end (void)
{
    ...
    bcm2835_gpio_fsel (16, BCM2835_GPIO_FSEL_INPT); /* SPI1_CE2_N */
    bcm2835_gpio_fsel (19, BCM2835_GPIO_FSEL_INPT); /* SPI1_MISO */
    bcm2835_gpio_fsel (20, BCM2835_GPIO_FSEL_INPT); /* SPI1_MOSI */
    bcm2835_gpio_fsel (21, BCM2835_GPIO_FSEL_INPT); /* SPI1_SCLK */
}
